...
interface CandidateSupportNoResultsProps {
  onClearFilters: () => void;
}

export function CandidateSupportNoResults({ onClearFilters }: CandidateSupportNoResultsProps) {
  return (
    <div className="p-8 text-center bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl shadow-xs space-y-3">
      ...
      <div className="max-w-sm mx-auto space-y-1">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400">
          Try clearing your search query or selecting another status tab or category filter.
        </p>
      </div>
