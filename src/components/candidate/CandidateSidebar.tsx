  ...
  const navGroups: NavGroup[] = [
    {
      ...
      items: [
        ...
        { label: 'My Documents', path: '/candidate/documents', icon: FileText, badgeCount: 1, badgeSeverity: 'normal' },
        { label: 'Check Eligibility', path: '/eligibility', icon: CheckCircle2 }
      ]
    },
    {
      title: 'Opportunities',
    ...
    },
    {
      ...
      items: [
        { label: 'Video Interviews', path: '/candidate/interviews', icon: Video, badgeCount: 1, badgeSeverity: 'critical' },
        { label: 'Conditional Offers', path: '/candidate/offers', icon: Award, badgeCount: 1 },
        { label: 'Mobility Placement', path: '/candidate/placement', icon: PlaneTakeoff }
      ]
    },
    {
