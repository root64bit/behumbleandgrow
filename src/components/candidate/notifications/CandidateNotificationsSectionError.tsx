...
interface CandidateNotificationsSectionErrorProps {
  message?: string;
  onRetry: () => void;
}

export function CandidateNotificationsSectionError({
  message = 'We could not update your notifications.',
  onRetry,
}: CandidateNotificationsSectionErrorProps) {
  return (
