...
export const CandidateInterviewDetailsErrorState: React.FC<Props> = ({ message, onRetry }) => {
  return (
    <div className="max-w-md mx-auto my-12 p-8 bg-white border border-red-200 rounded-2xl shadow-xs text-center space-y-4 text-left">
      ...
      <div className="space-y-1 text-center">
        <h3 className="text-base font-extrabold text-[#00122B]">We Could Not Load This Interview</h3>
