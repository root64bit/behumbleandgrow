...
export default function SuperAdminSidebar({
  ...
  const navGroups: NavGroup[] = [
    {
      ...
      items: [
        ...
        { label: 'Live Activity', path: '/superadmin/dashboard#activity', icon: Activity }
      ]
    },
    {
      title: 'Organisations',
      items: [
        { label: 'Partners & Employers', path: '/superadmin/organisations', icon: Building2, badgeCount: 4, badgeSeverity: 'normal' },
        { label: 'Verification Queue', path: '/superadmin/organisations#verification', icon: BadgeCheck, badgeCount: 6, badgeSeverity: 'critical' }
      ]
    },
    {
      title: 'People & Access',
      items: [
        { label: 'Platform Users & Roles', path: '/superadmin/users', icon: Users, badgeCount: 3, badgeSeverity: 'normal' }
      ]
    },
    {
      title: 'Finance & Ledger',
      items: [
        { label: 'Payments & Refunds', path: '/superadmin/finance', icon: Receipt, badgeCount: 2, badgeSeverity: 'critical' }
      ]
    },
    {
      title: 'Compliance & Security',
      items: [
        { label: 'Security & Risk Audit', path: '/superadmin/security', icon: ShieldAlert }
      ]
    },
    {
  ...
  const isActive = (path: string) => {
    return location.pathname === path || (path !== '/superadmin/dashboard' && location.pathname.startsWith(path));
  };
