      ...
      <header className="bg-slate-950 text-white border-b border-slate-800 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <span className="font-bold text-white text-sm">Employer Portal</span>
              <div className="text-[10px] text-emerald-400 font-mono">UAE Verified Employer</div>
            </div>
          </div>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `px-3 py-1.5 rounded-lg text-xs font-medium flex items-center space-x-1.5 transition-colors whitespace-nowrap ${
                  isActive ? 'bg-emerald-600 text-white font-bold' : 'text-slate-400 hover:text-white hover:bg-slate-800'
                }`
              }
            >
